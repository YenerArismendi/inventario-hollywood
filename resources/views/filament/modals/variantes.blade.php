<div class="space-y-4">
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
        <table class="w-full text-sm text-left border-collapse">
            ...
            <tr>
                <th class="border-b border-gray-200 dark:border-gray-700 px-4 py-2">Nombre</th>
                <th class="border-b border-gray-200 dark:border-gray-700 px-4 py-2">Descripción</th>
            ...
            @forelse($variantes as $variante)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="px-4 py-2 text-gray-900 dark:text-gray-100">{{ $variante->nombre }}</td>
                    <td class="px-4 py-2 text-gray-700 dark:text-gray-300">{{ $variante->descripcion }}</td>
