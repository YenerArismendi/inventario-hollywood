...
class InsumoPolicy
{
    ...
    {
        return $user->can('view_any_insumo');
    }
    ...
    {
        return $user->can('restore_insumo');
    }
    ...
    {
        return $user->can('force_delete_insumo');
    }
}
